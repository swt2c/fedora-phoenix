...
%global snapshot_version dev3607+c1a0a4d
%global with_tests 0
...
Source0:        https://wxpython.org/Phoenix/snapshot-builds/%{tarname}-%{version}%{rc_version}.%{snapshot_version}.tar.gz
...
mv %{tarname}-%{version}%{rc_version}.%{snapshot_version} %{py2_builddir}
pushd %{py2_builddir}
%patch0 -p1
